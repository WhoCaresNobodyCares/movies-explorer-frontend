        ...
        >
          ...
          <div
            className={
              isValid
                ? 'login__separator'
                : `${!errors.loginFormEmailInput ? 'login__separator' : 'login__separator login__separator_error'}`
            }
          />
          ...
          <div className="login__block">
            ...
            <input
              ...
              className={
                isValid ? 'login__input' : `${!errors.loginFormPasswordInput ? 'login__input' : 'login__input login__input_invalid'}`
              }
          ...
          <div
            className={
              isValid
                ? 'login__separator'
                : `${!errors.loginFormPasswordInput ? 'login__separator' : 'login__separator login__separator_error'}`
            }
          />
          ...
          <div className="login__bottom">
            <button
              id="loginFormEdit"
              className={isValid && defaultButtonState ? 'login__submit' : 'login__submit login__submit_disabled'}
              name="loginFormEdit"
              aria-label="Войти"
              type="submit"
              onClick={() => {}}
