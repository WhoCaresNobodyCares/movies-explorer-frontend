...
const AboutMe = ({ mix }) => {
	...
	const links = [
		{
			href: 'https://github.com/WhoCaresNobodyCares',
			text: 'Facebook',
			key: 'about-me__link_1',
		},
		{
			href: 'https://github.com/WhoCaresNobodyCares',
			text: 'Github',
			key: 'about-me__link_2',
		},
	];
					...
					<div className="about-me__content">
						<div className="about-me__info">
							...
							<p
								...
								children={
									<>
										Занимаюсь разработкой веб-страниц и&nbsp;веб-приложений.
										Увлекаюсь лингвистикой, графикой и&nbsp;современными
