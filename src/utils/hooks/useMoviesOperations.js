const useMoviesOperations = () => {
  const searchMovies = (cards, words, isChecked) => {
  ...
  const getSavedMoviesIds = (allMovies, savedMovies) =>
    allMovies
      .map(item => {
        let match;
  ...
  return { searchMovies, getSavedMoviesIds, validateMovies };
};

export default useMoviesOperations;
